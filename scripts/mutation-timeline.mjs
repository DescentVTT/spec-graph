 ...
 * nothing. On the 2026-09-14 sweep they matched exactly for extract.ts (104),
 * state.ts (87), markdown.ts (55) and regex.ts (26), the files the shards are
 * balanced around.
 *
