...
const SUBJECTS: readonly string[] = [
  ...
  '\u00a0',
  '\u0001',
  // Either side of each ASCII letter run, where folding switches on and off,
  // and Latin-1 letters whose case forms are only ever reached through a range:
  // ASCII has a fast path now, so these are what the general one answers for.
  '@',
  'Z',
  '`',
  'z',
